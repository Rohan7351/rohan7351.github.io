...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://formsubmit.co/rohan.rana.7351@gmail.com', {
        method: 'POST',
        headers: {
          ...
          <div className="flex-1 min-w-[280px]">
            ...
            <div className="mt-6 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:rohan.rana.7351@gmail.com" className="hover:text-primary transition-colors">
                  rohan.rana.7351@gmail.com
                </a>
              </div>
              <div className="flex items-center gap-3">
                <FaLinkedin className="text-primary" />
                <a href="https://www.linkedin.com/in/rohan-rana-228a2b227/" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                  linkedin.com/in/rohan-rana-228a2b227/
                </a>
              </div>
              <div className="flex items-center gap-3">
                <FaGithub className="text-primary" />
                <a href="https://github.com/Rohan7351" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                  github.com/Rohan7351
                </a>
              </div>
            </div>
          </div>
